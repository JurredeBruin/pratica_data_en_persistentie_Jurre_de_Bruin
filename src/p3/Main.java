...
public class Main {
    ...
    private static void testReizigerDAO(ReizigerDAO rdao) throws SQLException {
        ...
        Reiziger sietske9 = new Reiziger(30, "S", "van", "Boers", Date.valueOf(geboodatum),gideonstraat3);
        rdao.save(sietske9);
        rdao.findAll();
//        System.out.println(reizigers.size() + " reizigers\n");
    ...
    private static void testAdresDAO() throws SQLException {
        ...
        Adres gideonstraat = new Adres(7, "8754kl", "786", "gideonstraat", "noorwegen",30);
        ...
        Adres reizigadres = adao.findByReiziger( rdao.findByid(1) );
        System.out.println(reizigadres);
        System.out.println();


        //delete adres
        Adres gideonstraat3 = new Adres(7, "9986ol", "786", "gideonstraat", "noorwegen",30);
        System.out.print("[Test] delete by id ");
